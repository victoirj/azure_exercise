...
namespace MicrosoftSpeechSDKSamples.WpfSpeechRecognitionSample
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        public MainWindow()
        {
			Console.WriteLine("LOLO MainWindow()");
        ...
        private void Initialize()
        {
			...
			this.SubscriptionKey = "cfb972204f66481cb6f67149f5faa216";
			this.CustomModelEndpointId = "https://westeurope.stt.speech.microsoft.com/speech/recognition/conversation/cognitiveservices/v133";
		...
		private void StartButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (!this.UseMicrophone)
            {
				...
				Console.WriteLine("LOLO StartButton_Click() for file:" + wavFileName);
			}
        ...
        private async Task CreateBaseReco()
        {
			...
			Console.WriteLine("LOLO Task() region:" + this.Region);
            ...
            {
				Console.WriteLine("LOLO Task() file must be submitted" );
				using (var audioInput = AudioConfig.FromWavFileInput(wavFileName))
                {
                    ...
                    {
						Console.WriteLine("LOLO Task() file must be submitted.... await");
						await this.RunRecognizer(basicRecognizer, RecoType.Base, stopBaseRecognitionTaskCompletionSource).ConfigureAwait(false);
                    }
               }
            }
        ...
        {
			Console.WriteLine("LOLO RunRecognizer()");
			...
			Console.WriteLine("LOLO RunRecognizer() sender:" );
